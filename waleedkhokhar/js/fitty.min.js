  ...
  (t.default = (function (e) {
    function t(e, t) {
      var i = n({}, F, t),
        r = e.map(function (e) {
          var t = n({}, i, { element: e });
          return (
            S(t), T(t), { element: e, fit: b(t, o.DIRTY), unsubscribe: w(t) }
          );
        });
      return l(), r;
    }
    function i(e) {
      ...
      return "string" == typeof e
        ? t(r(document.querySelectorAll(e)), n)
        : t([e], n)[0];
    }
    if (e) {
      var r = function (e) {
        ...
        T = function (e) {
          e.observeMutations &&
            ((e.observer = new MutationObserver(b(e, o.DIRTY_CONTENT))),
        ...
        F = {
          ...
          maxSize: 512,
          multiLine: !0,
          observeMutations: "MutationObserver" in e && z,
        },
        g = null,
        D = function () {
          e.clearTimeout(g),
            (g = e.setTimeout(c(o.DIRTY_LAYOUT), i.observeWindowDelay));
        },
