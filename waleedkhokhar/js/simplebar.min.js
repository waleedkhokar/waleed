    ...
    return [
      ...
      function (t) {
        ...
        for (var a, c = [], l = 0; null !== (a = Ci(i, o)); ) {
          var u = String(a[0]);
          (c[l] = u),
            "" === u && (i.lastIndex = zi(o, st(i.lastIndex), s)),
            l++;
        }
        return 0 === l ? null : c;
      },
  ...
  Yt &&
    window.addEventListener("resize", function () {
      $i !== window.devicePixelRatio &&
        (($i = window.devicePixelRatio), (qi = null));
    });
  var Yi = (function () {
    function t(e, r) {
      var n = this;
